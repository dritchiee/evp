...
public class RemediationInstructionFragment extends ListFragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		View layout = inflater.inflate(pl.enterprise.vpn.client.R.layout.remediation_instruction, container, false);
		FrameLayout list = (FrameLayout)layout.findViewById(pl.enterprise.vpn.client.R.id.list_container);
	...
	public void onActivityCreated(Bundle savedInstanceState)
	{
		...
		setListShown(true);
		mTitle = (TextView)getView().findViewById(pl.enterprise.vpn.client.R.id.title);
		mDescription = (TextView)getView().findViewById(pl.enterprise.vpn.client.R.id.description);
		mHeader = (TextView)getView().findViewById(pl.enterprise.vpn.client.R.id.list_header);
	}
