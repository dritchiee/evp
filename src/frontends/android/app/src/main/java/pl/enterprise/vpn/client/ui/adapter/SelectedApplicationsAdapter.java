...
import pl.enterprise.vpn.client.ui.widget.CheckableLinearLayout;
...
public class SelectedApplicationsAdapter extends BaseAdapter implements Filterable
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		else
		{
			...
			view = inflater.inflate(pl.enterprise.vpn.client.R.layout.selected_application_item, parent, false);
		}
		...
		ImageView icon = (ImageView)view.findViewById(pl.enterprise.vpn.client.R.id.app_icon);
		icon.setImageDrawable(item.getIcon());
		TextView text = (TextView)view.findViewById(pl.enterprise.vpn.client.R.id.app_name);
