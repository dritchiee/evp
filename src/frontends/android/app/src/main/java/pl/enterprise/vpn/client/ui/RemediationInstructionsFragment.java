...
import pl.enterprise.vpn.client.ui.adapter.RemediationInstructionAdapter;
...
public class RemediationInstructionsFragment extends ListFragment
{
	...
	public void onStart()
	{
		...
		boolean two_pane = getFragmentManager().findFragmentById(pl.enterprise.vpn.client.R.id.remediation_instruction_fragment) != null;
		if (two_pane)
