...
public class TrustedCertificateImportActivity extends AppCompatActivity
{
	...
	private void importCertificate(Uri uri)
	{
		...
		if (certificate == null)
		{
			Toast.makeText(this, pl.enterprise.vpn.client.R.string.cert_import_failed, Toast.LENGTH_LONG).show();
			finish();
			return;
		}
...
//				.setIcon(R.drawable.ic_launcher)
				.setIcon(pl.enterprise.vpn.client.R.mipmap.test_launcher)
				.setTitle(pl.enterprise.vpn.client.R.string.import_certificate)
				.setMessage(certificate.getSubjectDN().toString())
				.setPositiveButton(pl.enterprise.vpn.client.R.string.import_certificate, new DialogInterface.OnClickListener()
				{
					@Override
					public void onClick(DialogInterface dialog, int whichButton)
					{
						...
						{
							Toast.makeText(getActivity(), pl.enterprise.vpn.client.R.string.cert_imported_successfully, Toast.LENGTH_LONG).show();
							getActivity().setResult(Activity.RESULT_OK);
						}
						else
						{
							Toast.makeText(getActivity(), pl.enterprise.vpn.client.R.string.cert_import_failed, Toast.LENGTH_LONG).show();
						}
						getActivity().finish();
					}
				})
