...
public class CertificateIdentitiesAdapter extends ArrayAdapter<String>
{
	...
	private void extractIdentities()
	{
		...
		{
			add(getContext().getString(pl.enterprise.vpn.client.R.string.profile_user_select_id_init));
		}
		else
		{
			add(String.format(getContext().getString(pl.enterprise.vpn.client.R.string.profile_user_select_id_default),
