...
import pl.enterprise.vpn.client.ui.adapter.TrustedCertificateAdapter;
...
public class TrustedCertificateListFragment extends ListFragment implements LoaderCallbacks<List<TrustedCertificateEntry>>, OnQueryTextListener
{
	...
	public void onActivityCreated(Bundle savedInstanceState)
	{
		...
		setEmptyText(getString(pl.enterprise.vpn.client.R.string.no_certificates));
	...
	{
		MenuItem item = menu.add(pl.enterprise.vpn.client.R.string.search);
