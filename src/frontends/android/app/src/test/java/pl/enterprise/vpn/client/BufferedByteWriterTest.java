...
import pl.enterprise.vpn.client.utils.BufferedByteWriter;
...
public class BufferedByteWriterTest
{
	...
	private void testArray(byte[] array, int offset)
	{
		...
		{
			Assert.assertEquals("value " + i, array[i], (i - offset) % 8);
		}
	}
	...
	public void testPutByteArray()
	{
		...
		Assert.assertEquals("length", array.length, 0);
		writer.put(testArray);
		array = writer.toByteArray();
		Assert.assertEquals("length", array.length, testArray.length);
		testArray(array);
	}
	...
	public void testResize()
	{
		...
		writer.put(testArray);
		byte[] array = writer.toByteArray();
		Assert.assertEquals("length", array.length, testArray.length * 4);
		testArray(array);
		writer.put(testArray);
		array = writer.toByteArray();
		Assert.assertEquals("length", array.length, testArray.length * 5);
		testArray(array);
	}
	...
	public void testPutByte()
	{
		...
		writer.put((byte)1);
		byte[] array = writer.toByteArray();
		Assert.assertEquals("length", array.length, 1);
		Assert.assertEquals("value", array[0], 1);
	}
	...
	public void testPutLen8()
	{
		...
		byte[] array = writer.toByteArray();
		Assert.assertEquals("length", array.length, testArray.length + 1);
		Assert.assertEquals("value", array[0], testArray.length);
		testArray(array, 1);
	}
	...
	public void testPutLen16()
	{
		...
		byte[] array = writer.toByteArray();
		Assert.assertEquals("length", array.length, testArray.length + 2);
		Assert.assertEquals("value 0", array[0], 0);
		Assert.assertEquals("value 1", array[1], testArray.length);
		testArray(array, 2);
	}
