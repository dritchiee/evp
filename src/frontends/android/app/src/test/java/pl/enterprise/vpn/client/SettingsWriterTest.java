...
public class SettingsWriterTest
{
	...
	public void testString()
	{
		...
		Assert.assertEquals("serialized", "", writer.serialize());
		writer.setValue("key", "value");
		Assert.assertEquals("serialized", "key=\"value\"\n", writer.serialize());
	}
	...
	public void testInt()
	{
		...
		Assert.assertEquals("serialized", "key=\"1234\"\n", writer.serialize());
		writer.setValue("key", (Integer)null);
		Assert.assertEquals("serialized", "key=\n", writer.serialize());
	}
	...
	public void testBoolean()
	{
		...
		Assert.assertEquals("serialized", "key1=\"1\"\nkey2=\"0\"\n", writer.serialize());
	...
	public void testReplace()
	{
		...
		Assert.assertEquals("serialized", "key=\"other\"\n", writer.serialize());
	}
	...
	public void testChain()
	{
		...
		Assert.assertEquals("serialized", "key1=\"value\"\nkey2=\"1234\"\nkey3=\"1\"\n", writer.serialize());
	}
	...
	public void testEscape()
	{
		...
		Assert.assertEquals("serialized", "key=\"val\\\"ue\"\nnl=\"val\nue\"\nbs=\"val\\\\ue\"\n", writer.serialize());
	}
	...
	public void testSections()
	{
		...
		Assert.assertEquals("serialized", "sec {\nkey1=\"value\"\nkey2=\"1234\"\nsub {\nkey=\"1\"\n}\n}\n", writer.serialize());
	}
	...
	public void testOrder()
	{
		...
		Assert.assertEquals("serialized", "key1=\"other\"\nkey2=\"1234\"\n", writer.serialize());
	}
}
